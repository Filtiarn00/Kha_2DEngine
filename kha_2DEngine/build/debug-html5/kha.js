...
khaEngine2D_game_Game.get = function() {
...
var game_GameOne = function() {
	...
	khaEngine2D_entities_EntityManager.addSystem(new game_systems_ActorCameraSystem());
};
...
game_GameOne.prototype = $extend(khaEngine2D_game_Game.prototype,{
	...
	,update: function() {
		...
		if(this.doUpdate) {
			khaEngine2D_entities_EntityManager.update();
		}
	}
	,render: function(frames) {
...
game_systems_ActorPlayerSystem.prototype = $extend(khaEngine2D_entities_EntitySystem.prototype,{
	...
	,update: function() {
		...
		while(_g < _g1.length) {
			...
			actorInput.xInput = 0;
			actorInput.yInput = 0;
			if(khaEngine2D_input_Input.isKeyDown(65)) {
				actorInput.xInput = -1;
			}
			if(khaEngine2D_input_Input.isKeyDown(68)) {
				actorInput.xInput = 1;
			}
			if(khaEngine2D_input_Input.isKeyDown(87)) {
				actorInput.yInput = -1;
			}
			if(khaEngine2D_input_Input.isKeyDown(83)) {
				actorInput.yInput = 1;
			}
		}
	}
...
var khaEngine2D_entities_EntityManager = function() {
	khaEngine2D_entities_EntityManager.addWorld("Main");
};
...
khaEngine2D_entities_EntityManager.update = function() {
	var _this = khaEngine2D_entities_EntityManager.worlds;
...
khaEngine2D_entities_EntityManager.forceCheckForChanges = function() {
	var _this = khaEngine2D_entities_EntityManager.worlds;
	var i = new haxe_ds__$StringMap_StringMapIterator(_this,_this.arrayKeys());
	while(i.hasNext()) {
		var i1 = i.next();
...
khaEngine2D_entities_EntityManager.render = function() {
	var _this = khaEngine2D_entities_EntityManager.worlds;
	var i = new haxe_ds__$StringMap_StringMapIterator(_this,_this.arrayKeys());
	while(i.hasNext()) {
		var i1 = i.next();
...
khaEngine2D_entities_EntityManager.addWorld = function(key) {
	khaEngine2D_entities_EntityManager.worlds = new haxe_ds_StringMap();
	var _this = khaEngine2D_entities_EntityManager.worlds;
	if(!(__map_reserved[key] != null ? _this.existsReserved(key) : _this.h.hasOwnProperty(key))) {
		var this1 = khaEngine2D_entities_EntityManager.worlds;
		...
		var _this2 = khaEngine2D_entities_EntityManager.worlds;
		khaEngine2D_entities_EntityManager.worldToEdit = __map_reserved[key] != null ? _this2.getReserved(key) : _this2.h[key];
	}
};
khaEngine2D_entities_EntityManager.addSystem = function(system) {
	if(khaEngine2D_entities_EntityManager.worldToEdit == null) {
		khaEngine2D_entities_EntityManager.addWorld("main");
	}
	khaEngine2D_entities_EntityManager.worldToEdit.addSystem(system);
};
khaEngine2D_entities_EntityManager.removeSystem = function(system) {
	if(khaEngine2D_entities_EntityManager.worldToEdit == null) {
		khaEngine2D_entities_EntityManager.addWorld("main");
	}
	HxOverrides.remove(khaEngine2D_entities_EntityManager.worldToEdit.systems,system);
};
khaEngine2D_entities_EntityManager.createEntity = function() {
	if(khaEngine2D_entities_EntityManager.worldToEdit == null) {
		khaEngine2D_entities_EntityManager.addWorld("main");
	}
	return khaEngine2D_entities_EntityManager.worldToEdit.createEntity();
};
khaEngine2D_entities_EntityManager.getEntitiesWithComponents = function(entityComponents) {
	return khaEngine2D_entities_EntityManager.worldToEdit.getEntitiesWithComponents(entityComponents);
};
khaEngine2D_entities_EntityManager.addComponent = function(entity,entityComponent) {
	khaEngine2D_entities_EntityManager.worldToEdit.addComponent(entity,entityComponent);
};
khaEngine2D_entities_EntityManager.removeComponent = function(entity,entityComponent) {
	khaEngine2D_entities_EntityManager.worldToEdit.removeComponent(entity,entityComponent);
};
khaEngine2D_entities_EntityManager.getComponent = function(entity,entityComponent) {
	return khaEngine2D_entities_EntityManager.worldToEdit.getComponent(entity,entityComponent);
};
khaEngine2D_entities_EntityManager.hasComponents = function(entity,entityComponentsToCheckFor) {
	return khaEngine2D_entities_EntityManager.worldToEdit.hasComponents(entity,entityComponentsToCheckFor);
};
khaEngine2D_entities_EntityManager.hasComponent = function(entity,entityComponent) {
	return khaEngine2D_entities_EntityManager.hasComponent(entity,entityComponent);
};
...
khaEngine2D_game_Scene.setBackgroundColor = function(color) {
	khaEngine2D_game_Scene.backgroundColor = color;
	khaEngine2D_graphics_Camera.clearColor = color;
};
...
khaEngine2D_graphics_Camera.set = function(graphics) {
	khaEngine2D_graphics_Camera.view.z = kha_System.windowWidth();
	khaEngine2D_graphics_Camera.view.w = kha_System.windowHeight();
	if(khaEngine2D_graphics_Camera.bounds.z > khaEngine2D_graphics_Camera.bounds.x) {
		if(khaEngine2D_graphics_Camera.position.x < khaEngine2D_graphics_Camera.view.x) {
			khaEngine2D_graphics_Camera.position.x = khaEngine2D_graphics_Camera.view.x;
		}
		if(khaEngine2D_graphics_Camera.position.x > khaEngine2D_graphics_Camera.bounds.z - khaEngine2D_graphics_Camera.view.x) {
			khaEngine2D_graphics_Camera.position.x = khaEngine2D_graphics_Camera.bounds.z - khaEngine2D_graphics_Camera.view.x;
		}
	}
	if(khaEngine2D_graphics_Camera.bounds.w > khaEngine2D_graphics_Camera.bounds.y) {
		if(khaEngine2D_graphics_Camera.position.y < khaEngine2D_graphics_Camera.view.y) {
			khaEngine2D_graphics_Camera.position.y = khaEngine2D_graphics_Camera.view.y;
		}
		if(khaEngine2D_graphics_Camera.position.y > khaEngine2D_graphics_Camera.bounds.w - khaEngine2D_graphics_Camera.view.y) {
			khaEngine2D_graphics_Camera.position.y = khaEngine2D_graphics_Camera.bounds.w - khaEngine2D_graphics_Camera.view.y;
		}
	}
	khaEngine2D_graphics_Camera.view.x = khaEngine2D_graphics_Camera.view.z * 0.5;
	khaEngine2D_graphics_Camera.view.y = khaEngine2D_graphics_Camera.view.w * 0.5;
...
khaEngine2D_graphics_Camera.getViewHeight = function() {
	return khaEngine2D_graphics_Camera.view.w;
};
khaEngine2D_graphics_Camera.unset = function(graphics) {
	graphics.popTransformation();
};
khaEngine2D_graphics_Camera.isInView = function(x,y) {
	var inBounds = true;
	if(inBounds) {
		inBounds = x >= khaEngine2D_graphics_Camera.position.x - khaEngine2D_graphics_Camera.view.x;
	}
	if(inBounds) {
		inBounds = x <= khaEngine2D_graphics_Camera.position.x + khaEngine2D_graphics_Camera.view.z - khaEngine2D_graphics_Camera.view.x;
	}
	if(inBounds) {
		inBounds = y >= khaEngine2D_graphics_Camera.position.y - khaEngine2D_graphics_Camera.view.y;
	}
	if(inBounds) {
		inBounds = y <= khaEngine2D_graphics_Camera.position.y + khaEngine2D_graphics_Camera.view.w - khaEngine2D_graphics_Camera.view.y;
	}
	return inBounds;
};
...
khaEngine2D_imgui_Imgui.begin = function(graphics,clear) {
	if(khaEngine2D_imgui_Imgui.graphics == null) {
		kha_input_Mouse.get().notify(khaEngine2D_imgui_Imgui.onMouseDown,khaEngine2D_imgui_Imgui.onMouseUp,khaEngine2D_imgui_Imgui.onMouseMove,null);
	}
	khaEngine2D_imgui_Imgui.graphics = graphics;
...
khaEngine2D_imgui_Imgui.addFont = function(key,font) {
	...
	if((__map_reserved[key] != null ? _this.getReserved(key) : _this.h[key]) == null) {
		if(khaEngine2D_imgui_Imgui.currentFont == null) {
			khaEngine2D_imgui_Imgui.currentFont = font;
			khaEngine2D_imgui_Imgui.graphics.set_font(khaEngine2D_imgui_Imgui.currentFont);
		}
		var _this1 = khaEngine2D_imgui_Imgui.fonts;
		if(__map_reserved[key] != null) {
			_this1.setReserved(key,font);
		} else {
			_this1.h[key] = font;
		}
	}
};
khaEngine2D_imgui_Imgui.setFont = function(key) {
	var _this = khaEngine2D_imgui_Imgui.fonts;
	khaEngine2D_imgui_Imgui.currentFont = __map_reserved[key] != null ? _this.getReserved(key) : _this.h[key];
	khaEngine2D_imgui_Imgui.graphics.set_font(khaEngine2D_imgui_Imgui.currentFont);
};
khaEngine2D_imgui_Imgui.getPressedId = function() {
	if(khaEngine2D_imgui_Imgui.pressedThisFrame) {
...
khaEngine2D_imgui_Imgui.onMouseMove = function(x,y,cx,cy) {
	khaEngine2D_imgui_Imgui.mousePosition.x = x;
	khaEngine2D_imgui_Imgui.mousePosition.y = y;
};
khaEngine2D_imgui_Imgui.isMouseInRect = function(rect) {
	if(khaEngine2D_imgui_Imgui.mousePosition.x >= rect.x && khaEngine2D_imgui_Imgui.mousePosition.x <= rect.x + rect.z && khaEngine2D_imgui_Imgui.mousePosition.y >= rect.y) {
		return khaEngine2D_imgui_Imgui.mousePosition.y <= rect.y + rect.w;
	} else {
		return false;
	}
};
...
khaEngine2D_input_Input.Init = function() {
	kha_input_Keyboard.get().notify(khaEngine2D_input_Input.onKeyDown,khaEngine2D_input_Input.onKeyUp);
	kha_input_Mouse.get().notify(khaEngine2D_input_Input.onMouseDown,khaEngine2D_input_Input.onMouseUp,khaEngine2D_input_Input.onMouseMove,null);
};
khaEngine2D_input_Input.getMousePosition = function() {
	return khaEngine2D_input_Input.mousePosition;
};
khaEngine2D_input_Input.isKeyDown = function(keyCode) {
	if(!khaEngine2D_input_Input.keyDowns.h.hasOwnProperty(keyCode)) {
		khaEngine2D_input_Input.keyDowns.h[keyCode] = false;
	}
	return khaEngine2D_input_Input.keyDowns.h[keyCode];
};
khaEngine2D_input_Input.onKeyDown = function(keyCode) {
	if(!khaEngine2D_input_Input.keyDowns.h.hasOwnProperty(keyCode)) {
		khaEngine2D_input_Input.keyDowns.h[keyCode] = false;
	}
	khaEngine2D_input_Input.keyDowns.h[keyCode] = true;
};
khaEngine2D_input_Input.onKeyUp = function(keyCode) {
	khaEngine2D_input_Input.keyDowns.h[keyCode] = false;
};
khaEngine2D_input_Input.getIsMouseDown = function() {
	return khaEngine2D_input_Input.isMouseDown;
};
khaEngine2D_input_Input.getIsMousePressed = function() {
	if(!khaEngine2D_input_Input.isMousePressed && khaEngine2D_input_Input.isMouseDown) {
		khaEngine2D_input_Input.isMousePressed = true;
		return true;
	}
	return false;
};
khaEngine2D_input_Input.onMouseDown = function(x,y,cx) {
	khaEngine2D_input_Input.isMouseDown = true;
};
khaEngine2D_input_Input.onMouseUp = function(x,y,cx) {
	khaEngine2D_input_Input.isMouseDown = false;
	khaEngine2D_input_Input.isMousePressed = false;
};
khaEngine2D_input_Input.onMouseMove = function(x,y,cx,cy) {
	khaEngine2D_input_Input.mousePosition.x = x;
	khaEngine2D_input_Input.mousePosition.y = y;
};
