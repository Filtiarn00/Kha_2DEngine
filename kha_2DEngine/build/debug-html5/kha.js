...
Main.initialized = function($window) {
	var editor1 = new editor_EditorOne();
};
Math.__name__ = "Math";
...
var khaEngine2D_editor_Editor = function() {
	this.theme = khaEngine2D_editor_ui_UIThemes.dark;
	this.uiCanvases = new haxe_ds_StringMap();
	var _gthis = this;
	khaEngine2D_editor_Editor.i = this;
...
$hxClasses["khaEngine2D.editor.Editor"] = khaEngine2D_editor_Editor;
khaEngine2D_editor_Editor.__name__ = "khaEngine2D.editor.Editor";
khaEngine2D_editor_Editor.getEditor = function() {
	return khaEngine2D_editor_Editor.i;
};
khaEngine2D_editor_Editor.prototype = {
	uiCanvases: null
	,theme: null
	,isPlaying: null
	,load: function() {
	...
	,render: function(frames) {
		...
		var _this = this.uiCanvases;
		var i = new haxe_ds__$StringMap_StringMapIterator(_this,_this.arrayKeys());
		while(i.hasNext()) {
			var i1 = i.next();
			i1.render(frames[0].get_g2(),this);
		}
		graphics.end();
	}
	,addCanvas: function(key) {
		var _this = this.uiCanvases;
		if((__map_reserved[key] != null ? _this.getReserved(key) : _this.h[key]) == null) {
			var uiCanvas = new khaEngine2D_editor_ui_UICanvas();
			var _this1 = this.uiCanvases;
			if(__map_reserved[key] != null) {
				_this1.setReserved(key,uiCanvas);
			} else {
				_this1.h[key] = uiCanvas;
			}
			return uiCanvas;
		}
		return null;
	...
	,__class__: khaEngine2D_editor_Editor
};
var editor_EditorOne = function() {
	khaEngine2D_editor_Editor.call(this);
	this.panelCanvas = this.addCanvas("Panel");
	this.panelCanvas.addUIElement(new khaEngine2D_editor_ui_UIButton(new kha_math_FastVector4(0,0,50,50)));
};
$hxClasses["editor.EditorOne"] = editor_EditorOne;
editor_EditorOne.__name__ = "editor.EditorOne";
editor_EditorOne.__super__ = khaEngine2D_editor_Editor;
editor_EditorOne.prototype = $extend(khaEngine2D_editor_Editor.prototype,{
	panelCanvas: null
	,load: function() {
	}
	,update: function() {
		khaEngine2D_editor_Editor.prototype.update.call(this);
	}
	,render: function(frames) {
		khaEngine2D_editor_Editor.prototype.render.call(this,frames);
	}
	,__class__: editor_EditorOne
});
var khaEngine2D_game_Game = function() {
	this.doUpdate = false;
	var _gthis = this;
	khaEngine2D_game_Game.i = this;
	kha_Scheduler.addTimeTask($bind(this,this.update),0,0.016666666666666666);
	kha_System.notifyOnFrames(function(frames) {
		_gthis.render(frames);
	});
	kha_Assets.loadEverything($bind(this,this.load));
	this.scene = new khaEngine2D_game_Scene();
	this.input = new khaEngine2D_input_Input();
	this.entityManager = new khaEngine2D_entities_EntityManager();
};
$hxClasses["khaEngine2D.game.Game"] = khaEngine2D_game_Game;
khaEngine2D_game_Game.__name__ = "khaEngine2D.game.Game";
khaEngine2D_game_Game.getGame = function() {
	return khaEngine2D_game_Game.i;
};
khaEngine2D_game_Game.prototype = {
	scene: null
	,input: null
	,entityManager: null
	,doUpdate: null
	...
	,__class__: khaEngine2D_game_Game
};
...
$hxClasses["game.GameOne"] = game_GameOne;
...
var khaEngine2D_editor_ui_UIElement = function(rect) {
	this.rect = rect;
};
$hxClasses["khaEngine2D.editor.ui.UIElement"] = khaEngine2D_editor_ui_UIElement;
khaEngine2D_editor_ui_UIElement.__name__ = "khaEngine2D.editor.ui.UIElement";
khaEngine2D_editor_ui_UIElement.prototype = {
	rect: null
	,isPressed: null
	,isHovred: null
	,onClick: null
	,render: function(graphics,editor) {
	}
	,onMouseMove: function(x,y,z,w) {
		this.isHovred = x >= this.rect.x && x <= this.rect.x + this.rect.z && y >= this.rect.y && y <= this.rect.y + this.rect.w;
	}
	,onMouseDown: function(button,x,y) {
		if(x >= this.rect.x && x <= this.rect.x + this.rect.z && y >= this.rect.y && y <= this.rect.y + this.rect.w) {
			this.isPressed = true;
		}
	}
	...
	,__class__: khaEngine2D_editor_ui_UIElement
};
var khaEngine2D_editor_ui_UIButton = function(rect) {
	khaEngine2D_editor_ui_UIElement.call(this,rect);
};
$hxClasses["khaEngine2D.editor.ui.UIButton"] = khaEngine2D_editor_ui_UIButton;
khaEngine2D_editor_ui_UIButton.__name__ = "khaEngine2D.editor.ui.UIButton";
khaEngine2D_editor_ui_UIButton.__super__ = khaEngine2D_editor_ui_UIElement;
khaEngine2D_editor_ui_UIButton.prototype = $extend(khaEngine2D_editor_ui_UIElement.prototype,{
	render: function(graphics,editor) {
		khaEngine2D_editor_ui_UIElement.prototype.render.call(this,graphics,editor);
		...
		graphics.fillRect(this.rect.x,this.rect.y,this.rect.z,this.rect.w);
	}
	,__class__: khaEngine2D_editor_ui_UIButton
});
var khaEngine2D_editor_ui_UICanvas = function() {
	this.uiElements = [];
	kha_input_Mouse.get().notify($bind(this,this.onMouseDown),$bind(this,this.onMouseUp),$bind(this,this.onMouseMove),null);
};
$hxClasses["khaEngine2D.editor.ui.UICanvas"] = khaEngine2D_editor_ui_UICanvas;
khaEngine2D_editor_ui_UICanvas.__name__ = "khaEngine2D.editor.ui.UICanvas";
khaEngine2D_editor_ui_UICanvas.prototype = {
	uiElements: null
	,render: function(graphics,editor) {
		var _g = 0;
	...
	,__class__: khaEngine2D_editor_ui_UICanvas
};
var khaEngine2D_editor_ui_UIThemes = function() { };
$hxClasses["khaEngine2D.editor.ui.UIThemes"] = khaEngine2D_editor_ui_UIThemes;
khaEngine2D_editor_ui_UIThemes.__name__ = "khaEngine2D.editor.ui.UIThemes";
...
khaEngine2D_entities_EntityManager.prototype = {
	...
	,addWorld: function(key) {
		if(this.worlds == null) {
			this.worlds = new haxe_ds_StringMap();
		}
		var _this = this.worlds;
		if(!(__map_reserved[key] != null ? _this.existsReserved(key) : _this.h.hasOwnProperty(key))) {
			var this1 = this.worlds;
			var value = new khaEngine2D_entities_EntityWorld();
			var _this1 = this1;
			if(__map_reserved[key] != null) {
			...
			var _this2 = this.worlds;
			this.worldToEdit = __map_reserved[key] != null ? _this2.getReserved(key) : _this2.h[key];
		}
	}
	,addSystem: function(system) {
		this.worldToEdit.addSystem(system);
	}
	,removeSystem: function(system) {
		HxOverrides.remove(this.worldToEdit.systems,system);
	}
	,createEntity: function() {
		return this.worldToEdit.createEntity();
	}
	,getEntitiesWithComponents: function(entityComponents) {
		return this.worldToEdit.getEntitiesWithComponents(entityComponents);
	}
	,addComponent: function(entity,entityComponent) {
		this.worldToEdit.addComponent(entity,entityComponent);
	}
	,removeComponent: function(entity,entityComponent) {
		this.worldToEdit.removeComponent(entity,entityComponent);
	}
	,getComponent: function(entity,entityComponent) {
		return this.worldToEdit.getComponent(entity,entityComponent);
	}
	,hasComponents: function(entity,entityComponentsToCheckFor) {
		return this.worldToEdit.hasComponents(entity,entityComponentsToCheckFor);
	}
	,hasComponent: function(entity,entityComponent) {
		return this.hasComponent(entity,entityComponent);
	}
...
var khaEngine2D_game_Scene = function() {
	this.bounds = new kha_math_FastVector4(0,0,1000,1000);
	this.backgroundColor = -16777216;
	khaEngine2D_game_Scene.i = this;
};
$hxClasses["khaEngine2D.game.Scene"] = khaEngine2D_game_Scene;
khaEngine2D_game_Scene.__name__ = "khaEngine2D.game.Scene";
khaEngine2D_game_Scene.getScene = function() {
	return khaEngine2D_game_Scene.i;
};
khaEngine2D_game_Scene.prototype = {
	...
	,setBackgroundColor: function(color) {
		...
		var camera = khaEngine2D_graphics_Camera.GetCamera();
		if(camera != null) {
			khaEngine2D_graphics_Camera.GetCamera().clearColor = color;
		}
	}
	...
	,render: function() {
		khaEngine2D_graphics_SpriteBatch.getGraphics().drawRect(0,0,this.bounds.z,this.bounds.w);
	}
	,__class__: khaEngine2D_game_Scene
};
...
khaEngine2D_graphics_Camera.prototype = {
	...
	,set: function(graphics) {
		...
		this.view.x = this.view.z * 0.5;
		this.view.y = this.view.w * 0.5;
	...
	,getScreenToWorldSpace: function(x,y) {
...
kha_Shaders.painter_colored_fragData1 = "s239:I3ZlcnNpb24gMzAwIGVzDQpwcmVjaXNpb24gbWVkaXVtcCBmbG9hdDsNCnByZWNpc2lvbiBoaWdocCBpbnQ7DQoNCm91dCBoaWdocCB2ZWM0IEZyYWdDb2xvcjsNCmluIGhpZ2hwIHZlYzQgZnJhZ21lbnRDb2xvcjsNCg0Kdm9pZCBtYWluKCkNCnsNCiAgICBGcmFnQ29sb3IgPSBmcmFnbWVudENvbG9yOw0KfQ0KDQo";
...
kha_Shaders.painter_colored_vertData1 = "s330:";
...
kha_Shaders.painter_image_fragData1 = "s511:";
...
kha_Shaders.painter_image_vertData1 = "s403:";
...
kha_Shaders.painter_text_fragData1 = "s387:";
...
kha_Shaders.painter_text_vertData1 = "s424:";
...
kha_Shaders.painter_video_fragData1 = "s511:";
...
kha_Shaders.painter_video_vertData1 = "s403:";
...
khaEngine2D_editor_ui_UIThemes.dark = { BUTTON_TEXT_COLOR : -3487289, BUTTON_NORMAL_COLOR : -12040120, BUTTON_HOVER_COLOR : -12895429, BUTTON_PRESSED_COLOR : -15000805};
