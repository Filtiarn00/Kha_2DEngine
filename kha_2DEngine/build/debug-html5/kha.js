...
var khaEngine2D_editor_ui_UIElement = function(rect) {
	this.colorOff = -16777216;
	this.colorOn = -16711936;
	this.colorFrame = -1;
	this.rect = rect;
};
...
khaEngine2D_editor_ui_UIButton.prototype = $extend(khaEngine2D_editor_ui_UIElement.prototype,{
	render: function(graphics) {
		khaEngine2D_editor_ui_UIElement.prototype.render.call(this,graphics);
		graphics.drawRect(this.rect.x,this.rect.y,this.rect.z,this.rect.w,1);
	}
